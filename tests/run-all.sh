...
for t in amp-banner arc-bound bereavement delivery-match arc-relevancy commit-comprehension crm-entry-walk \
         ...
         message-constraints regen-variance-diag voi-conflict-directive refine-prohibitions regen-variance sms-optout-evidence first-reach-incentive stock-source step2-697 prompt-hygiene-698 cadence-calendar-699 step4-699 step5-700 stalled-rung-702 rung2-examples-704 log241-705 fallback-notice-706 bounce-707 sold-708 log243-709 log244-710 inventory-711 log245-712 kbb-variants-713 own-vehicle-715 chat-voi-716 all-hybrid-717 honda-trims-718 model-facts-719 imx-noappt-720 named-model-725 incentive-hold-726 appt-booked-727 scaffold-leak sold-scan splitframe-lead state-validity trade-attribution \
