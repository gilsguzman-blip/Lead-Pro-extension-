  ...
  function buildSourceSettingsUI(container, registry, onSave) {
    ...
    container.innerHTML = `
      <div style="padding:14px; display:flex; flex-direction:column; gap:10px;">
        ...
        <div id="ss-add-form" style="display:none; background:#131f33; border:1px solid rgba(0,210,150,0.15); border-radius:6px; padding:10px; display:flex; flex-direction:column; gap:6px;">
