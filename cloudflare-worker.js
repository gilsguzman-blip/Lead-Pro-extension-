 ...
 * - Fast capacity rejections (~1-2s) immediately cascade to next model
 ...
 *   fallback  — gemini-3-flash-preview      (reduced tokens, minimal thinking)
 *   emergency — gemini-3.1-flash-lite-preview (reduced tokens, minimal thinking)
 */
