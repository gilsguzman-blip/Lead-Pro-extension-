...
const LEADPRO_AUTH = (function() {
  ...
  const PERSONAS = {
    ...
    bdc: {
      // (v9.7.697) AUDIT H4 / M9: every example below is for TONE. None names a real vehicle ([Vehicle]),
      // claims a unit is here, uses scarcity, quotes a number, or names a real person ([Brand Specialist]
      // replaces "Matthew"). The Concierge bay line is conditional on a confirmed unit.
      id: 'bdc',
      label: 'BDC Agent',
      ...
      exampleSms: "Dylan, [Vehicle] is the right place to start. The one thing I cannot do over text is the trade appraisal — that has to be in person. Would Thursday afternoon or Friday morning be easier to swing by?",
      exampleEmail: "Dylan,\n\nThanks for the details on the [Vehicle]. A couple of things are easier in person than over text: how it actually feels from the driver's seat, and a real trade number on your current car. KBB gives you a starting figure, but the actual offer depends on the car in person.\n\nWould Wednesday around 5 or Saturday morning work better for you?",
      exampleVoicemail: "Hey Dylan, [Agent] at [Store]. Calling about the [Vehicle]. I can have the trade paperwork queued up ahead of time so you are not waiting around when you come in. Give me a shout back at 337-555-1234 — that's 337-555-1234.",
    ...
    sales: {
      ...
      tone: 'Confident, I-focused. Speak in outcomes. Frame the visit as low-stakes evaluation. Sound like a person who knows the deal, not a script.',
      ...
      exampleSms: "Got it — [Vehicle], and the color you asked about. If you can swing by tomorrow, I can have the trade appraisal done while you drive it, so you walk out knowing the real number. Morning or afternoon better?",
      exampleEmail: "Dylan,\n\nQuick note on the [Vehicle]. The piece I cannot do over text is your trade. KBB gives you a starting number; what we can actually pay against it depends on the car in person.\n\nIf you can come by tomorrow, I will have the appraisal queued up and we can run the actual deal — financing, trade, everything in one sitting. If the numbers do not land where you need them, you have not lost anything. If they do, you have a real answer.\n\nWhat time works?",
      exampleVoicemail: "Hey Dylan, [Agent] at [Store]. Calling about the [Vehicle]. If tomorrow works, I can have the trade appraisal ready when you walk in — you would not be guessing on numbers anymore. 337-555-1234 when you get a minute. Talk soon.",
    ...
    manager: {
      ...
      tone: 'Polished, intentional. Authority through restraint, not through repeating that you are the manager. Show you know the situation through specifics, not by announcing you reviewed it.',
      dos: ['Reference the specific vehicle, situation, or detail by name (shows you know without announcing it)', 'Offer your direct line when relevant', 'Validate the customer\'s time without hedging', 'Use one tone-shifting move per message: pressure removal, friction removal, or specific authority — not all three at once'],
    ...
    concierge: {
      ...
      exampleSms: "I'd be happy to set your visit up so you can explore the technology comfortably. Would you prefer a chilled water or a coffee when you arrive?",
      exampleEmail: "Dylan, I wanted to make your visit feel as effortless as possible. If your [Vehicle] is confirmed on the lot, I'll have it pulled into our indoor delivery bay before you arrive — climate controlled, quiet, no pressure. [Brand Specialist], your Brand Specialist, will walk you through the technology at whatever pace suits you. Would you prefer a chilled water or coffee waiting? And if there's a particular feature you'd like to see first, tell me and we'll start there.",
      exampleVoicemail: "Dylan, this is [Agent], your Audi Concierge at Audi Lafayette. I wanted to make sure your visit is set up exactly the way you'd want it. Your Brand Specialist [Brand Specialist] will be ready, and we'll take it at your pace. Give me a call back when you have a moment — 337-555-1234, that's 337-555-1234. Looking forward to it.",
