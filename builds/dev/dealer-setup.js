...
const LEADPRO_SETUP = (function() {
  ...
  // a quote in a stored store/group value previously broke the attribute (self-XSS class).
  function dsEsc(s) {
      ...
      container.innerHTML = `
        <div style="padding:16px; display:flex; flex-direction:column; gap:14px;">
          ...
          <div>
            ...
            <input id="ds-group-name" placeholder="e.g. Community Auto Group" value="${dsEsc(groupName)}"
        ...
        ">
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px;">
            <div>
              ...
              <input class="ds-store-name" data-idx="${idx}" value="${dsEsc(store.name || '')}"
            ...
            <div>
              ...
              <input class="ds-store-dealerid" data-idx="${idx}" value="${dsEsc(store.crmDealerId || '')}"
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px;">
            <div>
              ...
              <select class="ds-store-brand" data-idx="${idx}"
                ...
                ${allBrands.map(b =>
                  `<option value="${dsEsc(b.id)}" ${b.id === (store.brand || 'generic') ? 'selected' : ''}>${b.label}</option>`
                ).join('')}
              </select>
            </div>
            <div>
              ...
              <input class="ds-store-title" data-idx="${idx}"
                value="${dsEsc(store.titleTemplate || brandDef.title)}"
          ...
          <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px;">
            <div>
              ...
              <input class="ds-store-address" data-idx="${idx}" value="${dsEsc(store.address || '')}"
            ...
            <div>
              ...
              <input class="ds-store-phone" data-idx="${idx}" value="${dsEsc(store.phone || '')}"
            ...
            ">
              ...
              <div style="display:grid; grid-template-columns:1fr 1fr; gap:6px;">
                <div>
                  ...
                  <input class="asgn-phone" data-storeid="${store.id}" value="${dsEsc(asgn.phone || '')}"
                ...
                <div>
                  ...
                  <input class="asgn-title" data-storeid="${store.id}" value="${dsEsc(asgn.titleOverride || store.titleTemplate || brandDef.title)}"
                    style="background:#0d1625; border:1px solid rgba(0,210,150,0.1); border-radius:4px;
                    padding:5px 7px; color:#e8f0ff; font-size:10px; width:100%; box-sizing:border-box;">
                </div>
              </div>
